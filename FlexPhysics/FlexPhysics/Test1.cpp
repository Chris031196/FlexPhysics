...
namespace test1 {
	...
	bool mainLoop()
	{
		...
		DrawableConnection con13 = DrawableConnection(1.5f, 3.0f, 1.0f, element1, element3, element1->getProgram());
		DrawableConnection con24 = DrawableConnection(1.5f, 3.0f, 1.0f, element2, element4, element1->getProgram());
